...
class method { 
  ...
  <b>Login user: <font color='white'><b><?echo $_SESSION['ses_username']?>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </b></font>
  ...
  $query_getting_credits=mysql_query($sql_getting_credits);
  while($row_getting_credits=mysql_fetch_assoc($query_getting_credits)) {
