				...
				<div class="container">
						...
						<div class="col-sm-8 col-sm-offset-2 text">
							...
							<div class="description">
								<p>
									...
									The schedule in this site is based on the excel file that can be downloaded here <a href="http://en.apu.ac.jp/academic/uploads/fckeditor/public/registration/20160916_Timetable_for_Undergraduate_2016FA.xlsx">http://en.apu.ac.jp..</a>.</strong>
								</p>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6 col-sm-offset-3 form-box">
							<div class="text">
								<h1 class="description">Updating for SPRING 2017...</h1>
							</div>
						</div>
						<div class="col-sm-6 col-sm-offset-3 form-box">
